  ...
  <div class="mb-5 flex items-center gap-5 flex-wrap">
    ...
    <div class="flex items-center gap-6 shrink-0">
      ...
      <div>
        ...
        <a href="/account"><button class='toggle-tab' id='tab-login'>Aktywne bilety</button></a>
        <button class='toggle-tab active' id='tab-register'>Archiwalne bilety</button>
      </div>
    <?php if (empty($tickets)): ?>

            <div class='flex items-center justify-center min-h-[70vh]'>
              <div class='flex flex-col items-center gap-4'>
                <p class='text-lg'>Nie posiadasz archiwalnych biletów</p>
  ...
  <div class='grid grid-cols-1 lg:grid-cols-2 gap-5'>
    <?php foreach ($tickets as $ticket): ?>
      ...
      <div class="flex items-stretch">
        <!-- date strip -->
        <div class="bg-gray-500 text-white flex flex-col items-center justify-center px-3 sm:px-5 shrink-0 min-h-full py-5">
          <div class="font-display text-xl md:text-4xl font-semibold leading-tight"><?= e($ticket['event_date']) ?></div>
          <div class="text-xs text-gray-200 mt-0.5"><?= e($ticket['event_year']) ?></div>
        </div>
        <!-- content -->
        <div class="flex-1 p-2 sm:p-5 flex flex-row items-center gap-2 sm:gap-4">
          ...
          <div class="flex items-center gap-1 sm:gap-2 shrink-0 flex-wrap flex-col">
            ...
            <a href='/account/ticket/<?= e($ticket['ticket_ID']) ?>'><button class="bg-gray-500 text-white text-xs px-2 md:px-4 py-2.5 rounded-xl font-medium hover:bg-gray-400 transition-colors flex items-center justify-center gap-2 w-full cursor-pointer">
